...
arr_ipc = [0.307528,0.307564,0.307555][::-1]
arr_miss_rate = [0.5906910668459, 0.5905488865283561, 0.5905524116601961][::-1] #llc miss rates
x_axis_vals = [8,16,32]
x_axis_labels = ['(1024,32)','(2048,16)','(4096,8)']
