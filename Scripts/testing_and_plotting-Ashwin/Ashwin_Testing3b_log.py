                ...
                for l1d_set in [128]:
                    for l1d_way in [12]:
                        ...
                        with open("inc/cache.h", 'w') as f:
                            ...
                            data5 = f'{data4[:llc_latency_s]}#define LLC_LATENCY {func(1,llc_set*llc_way)}{data4[llc_latency_e:]}'
                        ...
                        with open(f"Ashwin_Results_3b_log_{tracename}_{repl}_{size1}_{size2}.txt", 'a') as f:
