...
arr_ipc = [0.307637,0.312407,0.320768]
arr_miss_rate = [0.6090758194790415,0.5562056193538879,0.47950542414651237] #llc miss rates
x_axis_vals = [1,2,3]
x_axis_labels = ['(2048,16)','(4096,16)','(8192,16)']


plt.title(f'IPC llc num sets')
