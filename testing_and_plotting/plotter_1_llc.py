...
arr_ipc = [0.307473,0.307528,0.307564]
arr_miss_rate = [0.5911599093806108,0.5906910668459, 0.5905488865283561] #llc miss rates
x_axis_vals = [8,16,32]
x_axis_labels = ['(4096,8)','(2048,16)','(1024,32)']


plt.title(f'const size, increasing llc associativity IPC')
...
plt.title(f'const size, increasing llc associativity Miss Rate')
