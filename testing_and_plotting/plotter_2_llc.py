...
arr_ipc = [0.305015,0.307528,0.312455]
arr_miss_rate = [0.6278236306037845, 0.5906910668459, 0.5397188354844471] #llc miss rates
x_axis_vals = [8,16,32]
x_axis_labels = ['(2048,8)','(2048,16)','(2048,32)']


plt.title(f'variable size, increasing llc associativity IPC')
...
plt.title(f'variable size, increasing llc associativity Miss Rate')
