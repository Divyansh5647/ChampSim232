...
arr_ipc = [0.312383,0.312407,0.312414]
arr_miss_rate = [0.05435332830229462,0.05403633839111101, 0.053736289757586146] #llc miss rates
x_axis_vals = [1,2,3]
x_axis_labels = ['(64,12)','(128,12)','(256,12)']


plt.title(f'IPC l1d num sets')
