...
arr_ipc = [0.304944,0.305015,0.306231]
arr_miss_rate = [0.6283782704259685, 0.6164731552891715, 0.6015164414296181] #llc miss rates
x_axis_vals = [4,8,16]
x_axis_labels = ['(1024,4)','(1024,8)','(1024,16)']


plt.title(f'variable size, increasing l2c associativity IPC')
...
plt.title(f'variable size, increasing l2c associativity Miss Rate')
