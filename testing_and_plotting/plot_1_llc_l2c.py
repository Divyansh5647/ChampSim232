...
arr_ipc_2 = [0.307526,0.307528,0.307529]
# arr_miss_rate_2 = [0.6169033919078997, 0.6164731552891715, 0.6164046826177558] #llc miss rates
x_axis_vals = [1,2,3]
x_axis_labels_1 = ['(2048,8)','(1024,16)','(512,32)']
x_axis_labels_2 = ['(2048,4)','(1024,8)','(512,16)']



plt.title(f'llc vs l2c constant size')
