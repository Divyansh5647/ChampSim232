...
arr_ipc = [0.307526,0.307528,0.307529]
arr_miss_rate = [0.6169033919078997, 0.6164731552891715, 0.6164046826177558] #llc miss rates
x_axis_vals = [4,8,16]
x_axis_labels = ['(2048,4)','(1024,8)','(512,16)']


plt.title(f'const size, increasing l2c associativity IPC')
...
plt.title(f'const size, increasing l2c associativity Miss Rate')
