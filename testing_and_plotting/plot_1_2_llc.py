...
for_legend = ["size constant","sets constant"]

name = "kissat-inc-high-30K-1802B.champsimtrace.xz"

arr_ipc_1 = [0.307473,0.307528,0.307564]
arr_miss_rate_1 = [0.5911599093806108,0.5906910668459, 0.5905488865283561] #llc miss rates

arr_ipc_2 = [0.305015,0.307528,0.312455]
arr_miss_rate_2 = [0.6278236306037845, 0.5906910668459, 0.5397188354844471]
x_axis_vals = [1,2,3]
x_axis_labels_1 = ['(2048,8)','(1024,16)','(512,32)']
x_axis_labels_2 = ['(2048,8)','(2048,16)','(2048,32)']



plt.title(f'const size vs variable size llc IPC')
...
plt.xticks(x_axis_vals,[8,16,32])
...
plt.title(f'const size vs variable size llc Miss Rate')
