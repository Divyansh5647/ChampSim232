...
void CACHE::handle_fill()
{
  ...
  /* 
  MSHR stands for "Miss Status Holding Register." It is a data structure used in computer 
  architecture to keep track of pending memory requests that are waiting to be fulfilled.
 */
